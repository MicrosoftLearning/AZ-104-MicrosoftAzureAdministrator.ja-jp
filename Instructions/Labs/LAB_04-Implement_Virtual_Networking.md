...
1. **[テンプレートの編集]** を選択してから、**[ファイルの読み込み]** を選択します。
...
1. **[+ レコード セット]** を選択します。 プライベート名前解決のサポートが必要な仮想ネットワークごとに、仮想ネットワーク リンク レコードを**追加**します。
...
1. **[DNS 管理]** を選択し、次に **[仮想ネットワーク リンク]** を選択します。 リンクを構成します。 

...
1. **[パブリック IP アドレスの追加]** ポップアップで、次の設定を使用してから **[保存]** を 2 回クリックします。 完了したら、 **[Next : Backend pools] (次へ: バックエンド プール)** をクリックします。
...
1. **[バックエンド プール]** タブで、次の設定を使って **[バックエンド プールの追加]** をクリックします (その他は既定値のままにします)。 **[追加]**、**[保存]** の順にクリックします。 **[次へ: 受信の規則]** をクリックします。

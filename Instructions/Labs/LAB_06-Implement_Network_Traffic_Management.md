...
1. 次の設定でピアリングを追加し (他のユーザーには既定値を残します)、**[追加]** をクリックします。
    ...
    | リモート仮想ネットワークへのアクセスを許可する | **チェック ボックスがオンになっていることを確認します (既定)** |
    ...
    | 現在の仮想ネットワークへのアクセスを許可する | **チェック ボックスがオンになっていることを確認します (既定)** |
    | リモート仮想ネットワークへのトラフィックを許可する | **チェック ボックスがオンになっていることを確認します (既定)** |

...
+ タスク 1:Azure Resource Manager テンプレートを作成します。
+ タスク 2:Azure Resource Manager テンプレートを編集してテンプレートを再デプロイします。
+ タスク 3:Cloud Shell を構成し、Azure PowerShell を使用してテンプレートをデプロイします。
+ タスク 4:CLI を使用してテンプレートをデプロイします。 
...
1. **[エディター]** (中かっこ) アイコンを選択し、パラメータ JSON ファイルに移動します。

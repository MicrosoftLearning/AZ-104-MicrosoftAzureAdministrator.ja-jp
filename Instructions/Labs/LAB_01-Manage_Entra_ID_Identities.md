...
lab:
  ...
  description: ユーザーとグループのアカウントを作成して構成します。
  duration: 30 minutes
  level: 300
  islab: true
  primarytopics:
...
1. 時間があれば、**[ライセンス]**、**[パスワード リセット]** などの他のオプションを探索してください。
   
### 新しいユーザーを作成する

1. **[管理]** ブレードで **[ユーザー]** を選択し、**[新しいユーザー]** ドロップダウンで **[新しいユーザーの作成]** を選択します。 
...
1. Azure portal で、`Microsoft Entra ID` を検索して選択します。 **[管理]** ブレードで、**[グループ]** を選択します。 

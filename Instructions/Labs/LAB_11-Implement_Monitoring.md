...
1. 必要に応じて、スコープ、使用している**サブスクリプション**を選択します。 **適用**を選択します。 

1. **[クエリ]** タブで、**[仮想マシン]** (左側のペイン) を選びます。 ブレードをもう一度開く必要がある場合があります。
...
1. 画面の右側で、**[簡易モード]** の横にあるドロップダウンを選択し、**KQL モード**を選びます。 クエリを確認します。 このクエリでは、*heartbeat* テーブルが使われています。

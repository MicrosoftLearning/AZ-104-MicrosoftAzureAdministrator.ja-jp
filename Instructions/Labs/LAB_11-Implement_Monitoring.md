...
1. **[az104-11-vm0 \| 診断設定]** ブレードの **[概要]** タブで、 **[診断ストレージ アカウント]** を選択して、 **[ゲスト レベルの監視を有効にする]** をクリックします。

    >**注**: 診断設定拡張機能がインストールされるまで待ちます。 これには 3 分ほどかかる場合があります。
...
1. **[az104-11-vm0 - ログ]** ブレードで、 **[Azure Monitor エージェント (推奨)]** を確実に選択して、 **[構成]** をクリックします。  

    >**注**: この操作が完了するのを待たず、代わりに次の手順に進みます。 操作には約 5 分間かかります。

...
1. 仮想マシンの横にある **[有効にする]** を選択してから、Azure Monitor の [Insights のオンボード] ブレードで **[有効にする]** を選択します。
...
1. アラートに関する作業を続けます。 **[アクション グループの使用]** を選択してから、**[アクション グループの選択]** ブレードで **[アクション グループの作成]** を選択します。

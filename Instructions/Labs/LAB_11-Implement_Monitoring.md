...
1. 既定値のまま、**[確認と有効化]**、**[有効にする]** の順に選択します。  
...
1. アラートに関する作業を続けます。 **[アクション]** タブに移動し、**[アクション グループの使用]** を選択し、次に **[アクション グループの選択]** ブレードで **[アクション グループの作成]** を選択します。
...
1. **[強制削除の適用]** チェック ボックスをオンにします。 下部で、リソースを削除することを確認するボックスをオンにし、**[削除]** を選択します。 
